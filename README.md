...
3. **Validate update available signature**<br>
   ...
   dgst -sha256 -sign private_key | base64```
...
8. **Act both on SC- and manifest-provided user confirmation request**<br>
...
9.  **Implement the allow downgrade flag**
