...
class SoftwareLoadingManagerSOTAService(dbus.service.Object):
    def __init__(self):
    ...
    def package_available(self, 
        ...
        if self.initiate_download_dbus == None:
    ...
    def download_complete(self,
        ...
        print "  target: {}".format(target)
        print "---"
        self.installation_report(package_id, major, minor, patch, 0, "installation successful")
        return True
...
slm_sota = SoftwareLoadingManagerSOTAService()
